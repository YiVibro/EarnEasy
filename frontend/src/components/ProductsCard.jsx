export default function ProductsCard({img, genre, productName, pricePerHour}) {
    return (
    <div className="bg-white rounded-2xl shadow-md p-2 min-w-[166px]">
          ...
          <div className="mt-0">
              ...
              <div className="flex flex-row justify-between">
                <button className="mt-3 bg-[#30B0C7] text-white font-semibold px-1 w-[100px] rounded-xl hover:scale-105">Edit</button>
                <button className="mt-3 bg-[#30B0C7] text-white font-semibold px-2 py-2 w-[100px] rounded-xl hover:scale-105">Delete</button>
              </div>
